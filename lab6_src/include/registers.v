...
`define IDS_LA_IN_READ_PTR     4'h0
`define IDS_LA_OUT_READ_PTR    4'h1
`define IDS_IDS_CMD            4'h2
`define IDS_PATTERN_LOW        4'h3
`define IDS_PATTERN_HIGH       4'h4
`define IDS_LA_IN_WORD_OUT_0   4'h5
`define IDS_LA_IN_WORD_OUT_1   4'h6
`define IDS_LA_IN_WORD_OUT_2   4'h7
`define IDS_LA_OUT_WORD_OUT_0  4'h8
`define IDS_LA_OUT_WORD_OUT_1  4'h9
`define IDS_LA_OUT_WORD_OUT_2  4'ha
`define IDS_MATCHES            4'hb
